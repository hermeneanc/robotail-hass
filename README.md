...
- UBPet ships with a fixed app namespace that targets the Airrobo app and an empty region code. The Robotail box lives in a
...
- Device entity for the litter box (serial `FBE002UBT50000XXX` family) with box
